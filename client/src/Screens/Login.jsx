                        ...
                        <div className='my-12 border-b text-center'>
                            ...
                            <div>
                                <Link
                                    ...
                                    className='no-underline hover:underline text-indigo-500 leading-none px-2 inline-block text-sm text-gray-600 tracking-wide font-medium bg-white transform translate-y-1/2'
                                >
                                    Forget password?
                                </Link>
                            </div><br />
